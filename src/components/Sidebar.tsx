...
const SYMPTOM_GROUPS = [
    { name: "耳鼻喉科急診-鼻", tags: ["流鼻血怎麼辦", "鼻血不止", "止血姿勢", "鼻血急診", "高血壓鼻血", "鼻血處理", "流鼻血處理", "耳鼻喉科急診", "耳鼻喉急診懶人包"] },
    { name: "耳鼻喉科急診-喉", tags: ["魚刺卡喉嚨", "吞飯團魚刺", "喝醋化魚刺", "魚刺急診", "耳鼻喉科夾魚刺"] },
    { name: "耳鼻喉科急診-耳", tags: ["耳朵跑進蟲", "耳道異物", "耳朵有蟲怎麼辦", "小孩耳朵塞東西", "耳鼻喉科夾耳屎蟲", "耳朵異物"] },
