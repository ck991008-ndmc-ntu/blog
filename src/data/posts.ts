...
export const posts: Post[] = [
    {
        ...
        summary: "一覺醒來單側耳朵突然聽不到，還伴隨耳鳴與悶脹感？這不是耳屎塞住，而是耳鼻喉科的急症。本文從最新 AAO-HNS 臨床指引出發，解析突發性感音神經性聽力損失的診斷流程、類固醇與高壓氧的治療策略比較，以及把握黃金治療期的關鍵。",
        date: "2026/06/28",
        category: "耳鼻喉專科",
        readTime: "8 min read",
        slug: "2026-06-28-sudden-hearing-loss",
        tags: ["耳鳴", "聽力下降", "眩暈"],
    },
    {
